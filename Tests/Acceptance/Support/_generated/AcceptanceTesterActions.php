<?php  //[STAMP] f28c66bb4f2b0c0e7985a88434bec22c
namespace EliasHaeussler\Typo3FormConsent\Tests\Acceptance\Support\_generated;
...
trait AcceptanceTesterActions
{
    ...
    public function fetchEmails(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('fetchEmails', func_get_args()));
    }
    ...
    public function accessInboxFor(string $address): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('accessInboxFor', func_get_args()));
    }
    ...
    public function accessInboxForTo(string $address): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('accessInboxForTo', func_get_args()));
    }
    ...
    public function accessInboxForCc(string $address): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('accessInboxForCc', func_get_args()));
    }
    ...
    public function accessInboxForBcc($address): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('accessInboxForBcc', func_get_args()));
    }
    ...
    public function deleteAllEmails(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('deleteAllEmails', func_get_args()));
    }
    ...
    public function openNextUnreadEmail(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('openNextUnreadEmail', func_get_args()));
    }
   ...
   * @param string $expected priority
     ...
     *
     *
     * @see \EliasHaeussler\Typo3FormConsent\Tests\Acceptance\Support\Helper\Email::grabUrlFromEmailBody()
     */
    public function grabUrlFromEmailBody(int $index = 0): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabUrlFromEmailBody', func_get_args()));
    }
     ...
     *
     * @return list<string>
     * @see \EliasHaeussler\Typo3FormConsent\Tests\Acceptance\Support\Helper\Email::grabAllUrlsFromEmailBody()
     */
    public function grabAllUrlsFromEmailBody(): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabAllUrlsFromEmailBody', func_get_args()));
    }
     ...
     *
     *
     * @see \EliasHaeussler\Typo3FormConsent\Tests\Acceptance\Support\Helper\Email::seeUrlsInEmailBody()
     */
    public function seeUrlsInEmailBody(?int $count = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeUrlsInEmailBody', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \EliasHaeussler\Typo3FormConsent\Tests\Acceptance\Support\Helper\Email::seeUrlsInEmailBody()
     */
    public function canSeeUrlsInEmailBody(?int $count = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeUrlsInEmailBody', func_get_args()));
    }
     ...
     *
     *
     * @see \EliasHaeussler\Typo3FormConsent\Tests\Acceptance\Support\Helper\Form::fillAndSubmitForm()
     */
    public function fillAndSubmitForm(string $form = \EliasHaeussler\Typo3FormConsent\Tests\Acceptance\Support\Helper\Form::DEFAULT, bool $attachFile = false): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('fillAndSubmitForm', func_get_args()));
    }
     ...
     * @see \EliasHaeussler\Typo3FormConsent\Tests\Acceptance\Support\Helper\Url::extractQueryParametersFromUrl()
     */
    public function extractQueryParametersFromUrl(string $url): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('extractQueryParametersFromUrl', func_get_args()));
    }
     ...
     *
     *
     * @see \EliasHaeussler\Typo3FormConsent\Tests\Acceptance\Support\Helper\Url::assertUrlPathEquals()
     */
    public function assertUrlPathEquals(string $expected, string $url): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assertUrlPathEquals', func_get_args()));
    }
     ...
     *
     *
     * @see \EliasHaeussler\Typo3FormConsent\Tests\Acceptance\Support\Helper\Url::assertQueryParameterEquals()
     */
    public function assertQueryParameterEquals(string $expected, string $url, string $path): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assertQueryParameterEquals', func_get_args()));
    }
}
